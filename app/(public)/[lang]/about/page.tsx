...
import { about as aboutEn } from '@/lib/i18n/locales/en/about';
import { about as aboutDe } from '@/lib/i18n/locales/de/about';
import { supportedLanguages, type Lang } from '@/lib/i18n/langs';

const translations = { en: aboutEn, de: aboutDe } as const;
