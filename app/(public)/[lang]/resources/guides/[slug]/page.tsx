...
export default function GuidePage({ params }: { params: { slug: string } }) {
  ...
  const language = (routeParams.lang as 'en' | 'de') || 'en';
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative max-w-5xl mx-auto px-6 pt-24 pb-16">
          <FadeIn>
            <Link href={l('/resources/guides')} className="inline-flex items-center gap-2 text-slate hover:text-signal transition-colors mb-8 group">
