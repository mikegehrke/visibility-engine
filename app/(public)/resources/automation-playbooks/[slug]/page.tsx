    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/resources/automation-playbooks">
    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8 pt-24 pb-16">
          <FadeIn>
            <Link href="/resources/automation-playbooks" className="inline-flex items-center gap-2 text-signal hover:text-signal/80 transition-colors mb-8">
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 pb-16">
        <FadeIn delay={1100}>
          <Link href="/resources/automation-playbooks" className="inline-flex items-center gap-2 text-signal hover:text-signal/80 transition-colors">
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 19.5 3 12m0 0 7.5-7.5M3 12h18" />
            </svg>
