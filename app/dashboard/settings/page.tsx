...
import { H2, Body, Overline } from '@/components/shared/Typography';
...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <Overline className="mb-2">Konfiguration</Overline>
        <H2>{title}</H2>
      </div>
      ...
      <Card variant="glass" className="p-8">
        <div className="flex flex-col items-center justify-center text-center py-8">
          ...
          <Body className="text-slate max-w-sm">{t.common.placeholder}</Body>
        </div>
      </Card>
    </div>
  );
