  ...
  en: {
    ...
    auth: {
      ...
      login: {
        ...
        heroTitle: 'Unlock Your Digital Visibility',
        heroSubtitle: 'Join thousands of creators and companies who trust Visibility Engine to grow their online presence.',
        statsUsers: 'Active Users',
        statsSignals: 'Signals Tracked',
        statsSatisfaction: 'Satisfaction',
        testimonialText: 'Visibility Engine transformed how we approach content distribution. Our engagement increased by 340% in just 3 months.',
        testimonialAuthor: 'Maria Kowalski',
        testimonialRole: 'Marketing Director, TechFlow',
  ...
  de: {
    ...
    auth: {
      ...
      login: {
        ...
        // Hero section (left side)
        heroTitle: 'Entfalte deine digitale Sichtbarkeit',
        heroSubtitle: 'Schließe dich tausenden von Creators und Unternehmen an, die Visibility Engine vertrauen, um ihre Online-Präsenz zu steigern.',
        statsUsers: 'Aktive Nutzer',
        statsSignals: 'Signale erfasst',
        statsSatisfaction: 'Zufriedenheit',
        testimonialText: 'Visibility Engine hat unsere Content-Distribution revolutioniert. Unser Engagement stieg in nur 3 Monaten um 340%.',
        testimonialAuthor: 'Maria Kowalski',
        testimonialRole: 'Marketing Director, TechFlow',
