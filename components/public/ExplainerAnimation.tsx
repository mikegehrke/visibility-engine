  ...
  return (
    <div className="relative w-full max-w-4xl mx-auto">
      ...
      <div className="relative bg-gradient-to-br from-ink via-ink to-slate-900 rounded-2xl overflow-hidden shadow-2xl aspect-video">
        ...
        {/* Animated Content */}
        <div className="relative z-10 h-full flex flex-col items-center justify-center p-8 sm:p-12">
          {/* Step Indicator */}
          ...
          <div className="w-full text-center mt-8">
            <h3 
              ...
              className="text-xl sm:text-2xl font-semibold text-white mb-3 animate-fade-in"
            >
              {steps[currentStep].title}
            </h3>
            <p 
              key={`desc-${currentStep}`}
              className="text-sm sm:text-base text-white/70 max-w-lg mx-auto animate-fade-in-delay"
            >
      ...
      <div className="flex items-center justify-between mt-6 px-2">
        ...
        <button
          onClick={togglePlay}
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-surface-1 border border-border hover:bg-surface-2 transition-colors"
        ...
        >
          ...
          <span className="text-sm font-medium text-ink">{labels[lang].replay}</span>
        </button>
      </div>
...
function SignalsVisual() {
  return (
    <div className="relative w-64 h-64">
      {/* Central hub */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full bg-signal flex items-center justify-center z-10">
  ...
  return (
    <div className="flex items-center gap-4">
      {platforms.map((p, i) => (
        ...
        >
          <div className={`w-16 h-16 rounded-2xl ${p.color} flex items-center justify-center text-2xl shadow-lg`}>
            {p.icon}
          </div>
  ...
  return (
    <div className="flex items-end gap-8">
      ...
      <div className="flex flex-col items-center gap-2">
        <div 
          className="w-20 bg-gradient-to-t from-green-500 to-green-400 rounded-t-lg"
          style={{
            height: '160px',
      ...
      {/* VS indicator */}
      <div className="text-white/40 font-bold text-lg mb-8">vs</div>

      {/* Your visibility bar */}
      <div className="flex flex-col items-center gap-2">
        <div 
          className="w-20 bg-gradient-to-t from-signal to-signal/80 rounded-t-lg"
          style={{
            height: '80px',
...
function ActionsVisual() {
  return (
    <div className="relative">
      ...
      <div 
        className="w-24 h-24 rounded-full bg-signal flex items-center justify-center shadow-lg shadow-signal/30"
        style={{
